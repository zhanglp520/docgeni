...
export interface docgenifixFsHost {
    ...
    watch(path: string, options?: docgenifixHostWatchOptions): Observable<HostWatchEvent>;
    watchAggregated(path: string | string[], options?: docgenifixHostWatchOptions): Observable<HostWatchEvent[]>;
    copy(src: string, dest: string, options?: docgenifixFsCopyOptions): Promise<void>;
...
export class docgenifixFsHostImpl implements docgenifixFsHost {
    ...
    async copy(src: string, dest: string, options?: docgenifixFsCopyOptions): Promise<void> {
...
export function createdocgenifixFsHost(host: virtualFs.Host): docgenifixFsHost {
    return new docgenifixFsHostImpl(host);
}
