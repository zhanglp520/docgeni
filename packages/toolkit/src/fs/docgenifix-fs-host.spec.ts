...
import { docgenifixFsHost, docgenifixFsHostImpl } from './docgenifix-fs-host';
import { createTestdocgenifixFsHost } from '../testing';

describe('#docgenifixfix-host', () => {
    let host: docgenifixFsHost;

    beforeEach(() => {
        host = createTestdocgenifixFsHost({
